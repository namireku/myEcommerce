...
if($_POST){
  ...
  foreach($required as $field){
    if($_POST[$field] == ''){
      $errors[] = 'All fields in Astrisks are required';
      break;
    }
  }
  if(!empty($_FILES)){
...
//      var_dump($mime[0]);
    ...
    $dbpath = '/Proj/images/products/'.$uploadName;
    if($mimeType != 'image'){
...
?>
  ...
  <form action="products.php?<?=((isset($_GET['edit']))?'edit='.$edit_id:'add=1');?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group col-md-6">
        <?php if($saved_image != ''): ?>
          <div class="saved-image">
            <img src="<?=$saved_image;?>" alt="saved image" style="width: auto ; height: 200px;" /><br/>
            <a href="products.php?delete_image=1&edit=<?=$edit_id;?>" class="text-danger">Delete image</a>
          </div>
        <?php else: ?>
          <label for="photo">Product Photo:</label>
          <input type="file" name="photo" id="photo" class="form-control"/><br/><br/><br/><br/>
        <?php endif; ?>
    </div>
    <div class="form-group col-md-6">
    ...
    <div class="form-group pull-right">
      ...
      <input type="submit" class="btn btn-success" value="<?=((isset($_GET['edit']))?'Edit':'Add');?> Product" style="margin-right: 19px; "/>
...
<a href="products.php?add=1" class="btn btn-success pull-right" id="add-product-btn" style="margin-top: -35px; margin-right: 5px;">Add Product</a><div class="clearfix"></div>
<hr/>
<table class="table table-bordered table-condensed table-striped" style="width : 99%; margin : 0 auto;">
